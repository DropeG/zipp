...
DEFAULT_WORK_DIR = STATE_DIR / "work"
MAPPINGS_FILE = STATE_DIR / "sync_mappings.json"
BLOCKED_PRODUCTS_FILE = STATE_DIR / "sync_blocked_products.json"
LEGACY_BLOCKED_PRODUCTS_FILE = BLOCKED_PRODUCTS_FILE
PUBLICATION_JOURNAL_FILE = STATE_DIR / "publication_journal.json"
RESERVATIONS_FILE = STATE_DIR / "selection_reservations.json"
QUALITY_RECORDS_FILE = STATE_DIR / "publication_quality_records.json"
WORKFLOW_LOCK_FILE = STATE_DIR / ".one_by_one.lock"
