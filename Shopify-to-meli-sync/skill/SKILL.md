...
~~~bash
PY=./venv/bin/python
WORK_DIR=data/product-publishing/one-by-one
~~~

The canonical state files are:

- 'automations/product-publishing/sync_mappings.json'
- 'automations/product-publishing/sync_blocked_products.json'
- 'automations/product-publishing/publication_journal.json'
- 'automations/product-publishing/selection_reservations.json'
- 'automations/product-publishing/publication_quality_records.json'
...
6. Run the local contract gate:
   ...
   ~~~bash
   $PY automations/product-publishing/scripts/one_by_one_sync.py block \
